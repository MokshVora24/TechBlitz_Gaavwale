...
export const EditorData = () => (
  <div>
    <h3>
    In our learning management system, we prioritize accessibility to ensure that every user, regardless of their abilities, can fully engage with the platform. We recognize the diverse needs of our users, including those with disabilities, and we're committed to creating an environment where everyone has equal opportunities to learn and succeed.
    <br/>
    One key component of our platform is the text editor, which is designed to be intuitive and user-friendly for individuals with varying needs. Whether a user is typing out a response to an assignment, formatting text for clarity, or simply jotting down notes, our text editor provides a seamless experience. Users can easily navigate through the interface and utilize the toolbar to apply formatting options such as bold, italic, underline, and more.
    <br/>
    Moreover, we understand that some users may require additional assistance while using the text editor. That's why we've integrated help documentation directly into the platform. By pressing the "Alt + H" shortcut, users can access comprehensive help resources that guide them through the text editor's features and functionalities. This ensures that users have the support they need to effectively utilize the text editor and engage with the content on our platform.
    <br/>
    At the core of our approach is the belief that accessibility is not just a feature but a fundamental aspect of inclusive design. By prioritizing accessibility in our platform, we aim to empower every learner, regardless of their abilities, to fully participate in the learning process and achieve their educational goals. We are committed to continuously improving our platform to ensure that it remains accessible and inclusive for all users.
    </h3>
  </div>
);
